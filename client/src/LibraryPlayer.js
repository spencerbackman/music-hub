...
// : <TrackPlayer key={this.props.id} id={this.props.id} name={this.props.name}
// track={this.props.track} artist={this.props.artist} albumn={this.props.albumn}
// preview={this.props.preview} artwork={this.props.artwork} index={this.state.index} /> 
// }